...
def generate_result_img(slices):
    ...
    :param slices: List of image slices extracted from the original image.

    :return: list : A generated image displaying all the slices in (possibly) multiple rows.
    """
    ...
    for index, el in enumerate(slices):  # Iterate through all the slices.
