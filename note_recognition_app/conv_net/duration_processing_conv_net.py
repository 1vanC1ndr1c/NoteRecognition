...
def train_note_duration_conv_net(test_data_percentage):
    """
    ...
    print("OHOOOOOOOOOOOOOOOOHOHOHOHO")
    print(test_data_label)
    print(train_data_arr)
    # todo something with name to get durations and so on, and so on....
...
#     duration_network_train_data_label = np.array([x for x in train_data_label if x[0] != "Uncategorized"])
#
#     duration_network_test_data_arr = np.array(
#         [x for i, x in enumerate(test_data_arr) if test_data_label[i][0] != "Uncategorized"])
#     duration_network_test_data_label = np.array([x for x in test_data_label if x[0] != "Uncategorized"])
#
...
#     duration_network_train_data_label_values_numerical = values_to_numerical(duration_network_train_data_label, class_names)
#
...
#             duration_network_train_data_label_values_numerical,
#             epochs=2,
