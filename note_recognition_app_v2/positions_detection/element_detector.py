...
for n, id_ in tqdm(enumerate(train_ids), total=len(train_ids)):
    ...
    for index, mask_file in enumerate(next(os.walk(path + '/masks/'))[2]):
        print('\r{} Working on {} ({} out of {})'.format(10 * " ", mask_file, index, total_masks), end="")
...
results = model.fit_generator(train_generator, validation_data=val_generator, validation_steps=20, steps_per_epoch=40,
                              # was 250
