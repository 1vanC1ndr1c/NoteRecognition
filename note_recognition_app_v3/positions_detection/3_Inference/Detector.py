...
with device("/cpu:0"):
    ...
    if __name__ == "__main__":
        ...
        parser.add_argument(
            ...
            help="Path to image/video directory. All subdirectories will be included. Default=" + image_test_folder, )
        parser.add_argument(
            "--output",
            type=str,
        ...
        parser.add_argument(
            ...
            default=False,
            action="store_true",
            help="Only save bounding box coordinates. Do not save output images with annotated boxes. Default=False.", )
        parser.add_argument(
            "--file_types",
            "--names-list",
            nargs="*",
            ...
            for i, img_path in enumerate(input_image_paths):
                ...
                for single_prediction in prediction:
                    out_df = out_df.append(
                        pd.DataFrame([[os.path.basename(img_path.rstrip("\n")), img_path.rstrip("\n"), ]
                                      + single_prediction
                                      + [x_size, y_size]],
                                     columns=[
                                         "image",
